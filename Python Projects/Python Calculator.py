...
Button(root,text="pi",command=lambda get_opration("*3.14")).grid(row=2,column=4,sticky=N+S+E+W)
Button(root,text="",command=lambda get_opration("*3.14")).grid(row=2,column=4,sticky=N+S+E+W)
Button(root,text="pi",command=lambda get_opration("*3.14")).grid(row=2,column=4,sticky=N+S+E+W)
Button(root,text="pi",command=lambda get_opration("*3.14")).grid(row=2,column=4,sticky=N+S+E+W)
